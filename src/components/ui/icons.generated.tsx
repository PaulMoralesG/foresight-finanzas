...
export function BarChart3(props: Props) {
  return <Icon name="bar-chart-3" {...props} />;
}
...
export function CalendarClock(props: Props) {
  return <Icon name="calendar-clock" {...props} />;
}
...
export function ClipboardList(props: Props) {
  return <Icon name="clipboard-list" {...props} />;
}
...
export function PieChart(props: Props) {
  return <Icon name="pie-chart" {...props} />;
}
